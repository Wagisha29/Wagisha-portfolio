        ...
        <div className="flex flex-col-reverse gap-10 md:flex-row md:items-center">
          <div className="relative flex-1 space-y-6">
            ...
            <div className="space-y-1">
              <h1 className="text-3xl font-extrabold leading-none tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
            ...
            <p className="max-w-xl border-l-2 border-cyan-500/80 py-1 pl-4 text-lg font-medium leading-snug text-slate-200 md:text-xl">
              Building scalable, performant web applications and intelligent
              AI-driven systems.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <a
                href="#projects"
                className="inline-flex items-center justify-center rounded-full border border-cyan-500/50 bg-cyan-500/10 px-6 py-2.5 text-sm font-semibold text-cyan-200 transition-colors hover:border-cyan-400 hover:bg-cyan-500/20 hover:text-cyan-100"
              >
                View Projects
              </a>
              <a
          ...
          <div className="flex-1 flex justify-center md:justify-end">
            <div className="w-full max-w-sm overflow-hidden rounded-2xl bg-white p-4 shadow-lg text-slate-900">
              ...
              <div className="mt-4 flex flex-col items-center text-center">
                ...
                Building full-stack web apps and AI agents with Python and React.
                </p>
